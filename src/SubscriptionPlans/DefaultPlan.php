...
class DefaultPlan extends BasePlan
{
     ...
     */
    public array $prices = [
        PlanTerms::Week->value => 0,
        PlanTerms::Month->value => 0,
        PlanTerms::Year->value => 0,
        PlanTerms::Life->value => 0,
    ];
    ...
    public string $heading = 'Default Plan';

    public string $subheading = 'This is the default plan for non-paying users';
